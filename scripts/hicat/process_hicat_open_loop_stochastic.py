...
dark_zone = hicat.get_dark_zone(SYSTEM_ID_TARGET_DIR)
...
for wl in WLS:
    ...
    system_id = hicat.EstimateOpenLoopHicatJacobian(
        SYSTEM_ID_TARGET_DIR, output_dir, G0=G_id, wl=wl
    )
    system_id.data = system_id.load_data(VALIDATION_ITERS)
